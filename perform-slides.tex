...
\begin{tikzpicture}
    ...
    \end{adjustbox}};
    \draw [red] (1.16,-2) node [red,anchor=south] {clang 5.0.0} -- +(0,-1);
    \draw [red] (7.01,-2) node [red,anchor=south] {clang 5.0.1} -- +(0,-1);
    \draw [red] (11.16,-2) node [red,anchor=south] {Meltdown} -- +(0,-1);
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}
    ...
    \end{adjustbox}};
    \draw [red] (3.59,-3.5) node [red,anchor=north] {retpoline} -- +(0,1.0);
    \draw [red] (5.60,-4.0) node [red,anchor=north] {witness}   -- +(0,1.0);
    \draw [red] (5.90,-4.5) node [red,anchor=north] {retguard}  -- +(0,1.0);
    \draw [red] (8.07,-4.0) node [red,anchor=north] {witness}   -- +(0,0.5);
\end{tikzpicture}
\end{frame}
...
\subsection{from 6.5, 123 Days, Align}
\begin{frame}{from 6.5, 123 Days, Align}
    \begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-08-13T10-02-43Z-tcp.tex}
    \end{adjustbox}
\end{frame}
