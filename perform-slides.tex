...
\begin{tikzpicture}
    ...
    \end{adjustbox}};
    \draw [red] (2.03,-2.5) node [red,anchor=south] {llvm ld}     -- +(0,-1.5);
...
\begin{tikzpicture}
    ...
    \end{adjustbox}};
    \draw [red] (1.90,-4) node [red,anchor=north] {tx mitigation} -- +(0,1);
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}
    \path (0,0) node [anchor=north west]
    {\begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-08-13T10-02-43Z-udp.tex}
    \end{adjustbox}};
    \draw [red] ( 1.90,-2.5) node [red,anchor=north] {tx mitigation} -- +(0,1);
    \draw [red] ( 4.90,-2.5) node [red,anchor=north] {MDS} -- +(0, 1);
    \draw [red] ( 6.90,-2.5) node [red,anchor=south] {TSC} -- +(0,-1);
    \draw [red] (13.10,-2.5) node [red,anchor=south] {TSC} -- +(0,-1);
\end{tikzpicture}
\end{frame}
