...
\subsection{Performace Tests Overview}
\begin{frame}{Regression Tests Overview}
\begin{tikzpicture}
    \path (0,0) node [anchor=north west]
...
\subsection{Performace Run at Date}
\begin{frame}{Regression Run at Date}
\begin{tikzpicture}
    \path (0,0) node [anchor=north west]
	...
	minimum height=0.7cm,draw,red,thick] {};
    \draw [draw,red,thick,->] (n1) -- (e1);
    \path (-1.5,-2.5) node (n2) [red,align=center] {avarage\\numbers};
