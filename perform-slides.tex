...
\begin{frame}{Weekly from 6.2 to 6.3}
    \includegraphics[width=\textwidth,trim=0 3.6cm 0 0,clip]
	{images/2019-02-04T15:10:35Z-tcp.png}
\end{frame}
