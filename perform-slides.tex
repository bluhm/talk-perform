...
\begin{frame}{6.5, 1 Day, 5 Tests, Keep Machine Running}
    \begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-08-10T05-41-55Z-tcp_7.tex}
    \end{adjustbox}
\end{frame}
...
\begin{frame}{6.5, 1 Day, 5 Tests, Reboot Machine}
    \begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-08-10T00-26-05Z-tcp_7.tex}
    \end{adjustbox}
\end{frame}
...
\begin{frame}{6.5, 1 Day, 5 Tests, Link and Reorder Kernel}
    \begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-08-09T20-22-42Z-tcp_7.tex}
    \end{adjustbox}
\end{frame}
...
\begin{frame}{6.5, 1 Day, 5 Tests, Sort Objects, Fixed Gap}
    \begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-08-09T16-57-09Z-tcp_7.tex}
    \end{adjustbox}
\end{frame}
...
\begin{frame}{6.5, 1 Day, 5 Tests, Sort Objects, Random Gap}
    \begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-08-09T13-35-53Z-tcp_7.tex}
    \end{adjustbox}
\end{frame}
...
\begin{frame}{6.5, 1 Day, 5 Tests, Align Sorted Objects, Fixed Gap}
    \begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-08-09T08-58-58Z-tcp_7.tex}
    \end{adjustbox}
\end{frame}
