...
\subsection{Existing Regress Tests}
...
\subsection{Hardware Regress}
\begin{frame}{Hardware Regess}
\begin{tikzpicture}
    ...
    \draw [->,red] (master) -- (console) node [midway,left] {control};
    \draw [->,red] (master) |- (local) node [midway,left] {control};
    \draw [->,red] (master) -| (local);
    \draw [->,red] (master) -| (remote) node [midway,above] {configure};
    \draw [->,red] (master) -| (router);
    \draw [->,red] (master) -| (server);
    \draw [->,red] (console) -| (local);
    \draw [->,red] (console) -| (remote) node [midway,below] {install};
...
\subsection{Hardware Perform Future}
