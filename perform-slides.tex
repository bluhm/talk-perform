...
\subsection{from 6.5, 154 Days, Align}
\begin{frame}{from 6.5, 154 Days, Align}
\begin{tikzpicture}
    \path (0,0) node [anchor=north west]
    {\begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-09-13T19-42-45Z-tcp.tex}
    \end{adjustbox}};
...
\begin{tikzpicture}
    \path (0,0) node [anchor=north west]
    {\begin{adjustbox}{totalheight=\textheight-3\baselineskip}
	\input{gnuplot/2019-09-13T19-42-45Z-udp.tex}
    \end{adjustbox}};
